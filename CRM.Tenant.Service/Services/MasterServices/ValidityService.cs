...
public class ValidityService : BaseService<CreateValidityRequest, ValidityModel>
{
    ...
    public ValidityService(IMapper mapper, BaseRepository<ValidityModel> repository, IValidator<CreateValidityRequest> validator, QuotationTermsService quotationTermsService, PurchaseOrderTermsService purchaseOrderTermsService)
